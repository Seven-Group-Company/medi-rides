...
export const useAdminBookingManagement = () => {
  ...
  // hooks/useAdminBookingManagement.ts - Updated fetchData function
const fetchData = useCallback(async () => {
  try {
    ...
    // Fetch all data in parallel - FIXED: Use correct backend URL
    const [customersRes, ridesRes, driversRes, vehiclesRes, statsRes] = await Promise.all([
      ...
      fetch(`${process.env.NEXT_PUBLIC_API_URL}/admin/rides`, { headers }),
  ...
  // Ride Actions
// Update all action functions to use the correct backend URL
...
// Similarly update declineRide, assignDriverAndVehicle, and updateCustomerStatus functions
